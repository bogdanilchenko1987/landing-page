export const subscriptions = [
  {
    ...
    period: "/ Month",
    description:
      "Ideal for individuals who need quick access to basic features and free use.",
    features: [
...
export const features = [
  {
    name: "Customization",
    text: "Tailor our product to suit your needs Tailor our product to suit your needs.",
    svg: (
      <svg
  ...
  {
    name: "Security",
    text: "Your data is protected by the latest security measures.",
    svg: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        fill="currentColor"
  ...
  {
    name: "Support",
    text: "Tailor our product to suit your needs 24/7 customer support for all your inquiries.",
    svg: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        fill="currentColor"
  ...
  {
    name: "Performance",
    text: "Experience blazing-fast performance with our product.",
    svg: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        fill="currentColor"
  ...
  {
    name: "Global Reach",
    text: "Tailor our product to suit your needs Expand your reach with our global network.",
    svg: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        fill="currentColor"
  ...
  {
    name: "Communication",
    text: "Tailor our product to suit your needs Seamless communication for your team.",
    svg: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        fill="currentColor"
...
export const clients = [
  ...
  },
  {
    name: "Mark Adair",
    founder: "Alpha",
    text: "Great experience! The team was professional, and the support was top-notch. I highly recommend their services.",
  },
  {
    name: "Simon Konecki",
    founder: "Labar",
    text: "Fantastic service! Their attention to detail and customer care really stood out. Will definitely use again.",
  },
];
